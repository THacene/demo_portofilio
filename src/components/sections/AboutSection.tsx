      ...
      <div className="w-full flex flex-col gap-6">
        ...
        <AnimationContainer customClassName="w-full flex flex-col gap-5 mb-8">
          <p className="text-base text-gray-400">
            Hey there! 👋 I'm <strong>{siteConfig.author}</strong>, a System and Web Technology Engineer who loves to create new things. I have uploaded some pretty cool stuff, so make sure to check it out on my
            <Link
          ...
          <ul className="text-base text-gray-400 list-disc pl-6 space-y-2 mt-4">
            ...
            <li>📚 I'm currently focused on learning and exploring the exciting fields of security  and system administrateur (mcsa), including neural networks and other related topics.</li>
